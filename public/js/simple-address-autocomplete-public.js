let autocomplete;
let inputSplit = simple_address_autocomplete_settings_vars.form_field_ids.trim().split(/\s*\n\s*/);
let inputValues = new Array();
let country_select = simple_address_autocomplete_settings_vars.country_selected;
